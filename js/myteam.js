...
const sharpIconTeam = document.getElementsByClassName('sharpIconTeam');
const dropdownMenuTeam = document.getElementsByClassName('dropdownMenuTeam');
...
const sharpIconTeamArray = Array.from(sharpIconTeam);

sharpIconTeamArray.forEach((sharpIcon, index) => {
    sharpIcon.addEventListener('click', () => {
        showHide(dropdownMenuTeam[index]);
    });
});
